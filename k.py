...
bot = telebot.TeleBot('7419315600:AAEwkL4aS5D5CLkifETvoxDiicJnklOmJrA')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access!🚫Please buy access :-@SAHREJ"
    bot.reply_to(message, response)
...
def welcome_start(message):
    ...
    response = f'''🫡WELCOME TO SAHREJ VIP DDOS BOT 🚀 '''
    bot.reply_to(message, response)
